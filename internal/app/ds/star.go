...
type Star struct {
	...
	FormDate              *time.Time `gorm:"default:null" json:"form_date"`
	FinishDate            *time.Time `gorm:"default:null" json:"finish_date"`
	...
	CompletedCalculations int        `json:"completed_calculations" gorm:"-"`
}
